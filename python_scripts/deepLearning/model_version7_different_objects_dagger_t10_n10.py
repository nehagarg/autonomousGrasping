...
def test(fileName=None):
    ...
    with tf.Session() as sess:
        ...
        model = Seq2SeqModel(session=sess,
                ...
                batch_size=training_batch_size,
                scope="model")
        model.load('version6/model.ckpt-800')
...
def main():
    ...
    if action == 'train':
        ...
        logfileName = '/home/neha/WORK_FOLDER/phd2013/phdTopic/despot/despot-0.2-server-version/4_objects_obs_prob_change_particles_as_state/deepLearning_different_objects/version6/dagger_data/graspingV4_state_' + repr(i) + '_t1_n10_obs_prob_change_particles_as_state_4objects.log'
        #logfileName = '/home/neha/WORK_FOLDER/phd2013/phdTopic/despot/despot-0.2-server-version/4_objects_obs_prob_change_particles_as_state/deepLearning_same_objects/version7/state_' + repr(i) + '.log'
