...
def main():
    ...
    #logfileName = '/home/neha/WORK_FOLDER/phd2013/phdTopic/despot/despot-0.2-server-version/4_objects_obs_prob_change_particles_as_state/graspingV3_state_' + stateId + '_t20_obs_prob_change_particles_as_state_4objects.log'
    ...
    if(logType=='learning_train_version7'):
        #logfileName = '/home/neha/WORK_FOLDER/phd2013/phdTopic/despot/despot-0.2-server-version/4_objects_obs_prob_change_particles_as_state/adaboost_different_objects/sensor_observation_sum/state_' + stateId + '.log' 
        #logfileName = '/home/neha/WORK_FOLDER/phd2013/phdTopic/despot/despot-0.2-server-version/4_objects_obs_prob_change_particles_as_state/adaboost_different_objects/state_' + stateId + '.log' 
        logfileName = '/home/neha/WORK_FOLDER/phd2013/phdTopic/despot/despot-0.2-server-version/4_objects_obs_prob_change_particles_as_state/deepLearning_same_objects/version7/state_' + stateId + '.log'
        drawBelief = False
    if(logType=='learning_test_version7'):
        logfileName = '/home/neha/WORK_FOLDER/phd2013/phdTopic/despot/despot-0.2-server-version/4_objects_obs_prob_change_particles_as_state/deepLearning_different_objects/version7/state_' + stateId + '.log'
    if(logType=='learning_test_version8'):
        logfileName = '/home/neha/WORK_FOLDER/phd2013/phdTopic/despot/despot-0.2-server-version/4_objects_obs_prob_change_particles_as_state/deepLearning_different_objects/version8/state_' + stateId + '.log'
        

    app = QApplication([])
    currentState = MainWindow(logfileName, drawBelief)
