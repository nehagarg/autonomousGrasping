...
void CUPDISPLAY::ObjectPoseCallback(const grasping_ros_mico::Belief::ConstPtr& msg) 
{
...
void CUPDISPLAY::GripperPoseCallback(const grasping_ros_mico::State::ConstPtr& msg) 
{
